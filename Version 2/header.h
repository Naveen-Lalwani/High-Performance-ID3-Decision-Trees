...
vi countDistinct(vvi&, int);								// Returns a vector of integers containing the counts of all the various values of an attribute/column
int decideSplittingColumn(vvi&);							// Returns the column on which to split on. Decision of column is based on entropy
...
int returnMostFrequentClass(vvi&);				// Returns the most frequent class from the training data. This class is used as the default class during the testing phase
