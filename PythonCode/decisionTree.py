...
def main():
	...
	for label, attr_dict in zip(label_list, attr_dict_list):
		...
		file.write("{}\n".format(pred))
	file.close()
	test_error_rate = 1 - (error_cnt / len(label_list))
